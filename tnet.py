...
def img_net(inputs, bit, numclass):
    ...
    W_fc8 = tf.random.normal([1, 1, 4096, SEMANTIC_EMBED], stddev=1.0) * 0.01
    b_fc8 = tf.random.normal([SEMANTIC_EMBED], stddev=1.0) * 0.01
    ...
    W_fc9 = tf.random.normal([1, 1, SEMANTIC_EMBED, bit], stddev=1.0) * 0.01 
    b_fc9 = tf.random.normal([bit], stddev=1.0) * 0.01
    ...
    W_fc10 = tf.random.normal([1, 1, SEMANTIC_EMBED, numclass], stddev=1.0) * 0.01
    b_fc10 = tf.random.normal([numclass], stddev=1.0) * 0.01
...
def lab_net(imput_label, bit, numClass):
    LAYER1_NODE = 4096
    labnet = {}
    W_fc1 = tf.random.normal([1, numClass, 1, LAYER1_NODE], stddev=1.0) * 0.01
    b_fc1 = tf.random.normal([1, LAYER1_NODE], stddev=1.0) * 0.01
    ...
    W_fc2 = tf.random.normal([1, 1, LAYER1_NODE, SEMANTIC_EMBED], stddev=1.0) * 0.01
    b_fc2 = tf.random.normal([1, SEMANTIC_EMBED], stddev=1.0) * 0.01
    ...
    W_fc3 = tf.random.normal([1, 1, SEMANTIC_EMBED, bit], stddev=1.0) * 0.01
    b_fc3 = tf.random.normal([1, bit], stddev=1.0) * 0.01
    ...
    W_fc4 = tf.random.normal([1, 1, SEMANTIC_EMBED, numClass], stddev=1.0) * 0.01
    b_fc4 = tf.random.normal([1, numClass], stddev=1.0) * 0.01
...
def txt_net(text_input, dimy, bit, numclass):
    ...
    W_fc1 = tf.random.normal([1, dimy, 6, 4096], stddev=1.0) * 0.01
    b_fc1 = tf.random.normal([1, 4096], stddev=1.0) * 0.01
    ...
    W_fc2 = tf.random.normal([1, 1, 4096, SEMANTIC_EMBED], stddev=1.0) * 0.01
    b_fc2 = tf.random.normal([1, SEMANTIC_EMBED], stddev=1.0) * 0.01
    ...
    W_fc3 = tf.random.normal([1, 1, SEMANTIC_EMBED, bit], stddev=1.0) * 0.01
    b_fc3 = tf.random.normal([bit], stddev=1.0) * 0.01
    ...
    W_fc4 = tf.random.normal([1, 1, SEMANTIC_EMBED, numclass], stddev=1.0) * 0.01
    b_fc4 = tf.random.normal([numclass], stddev=1.0) * 0.01
...
def interp_block(text_input, level):
    ...
    W_fc1 = tf.random.normal([1, 1, 1, 1], stddev=1.0) * 0.01
    fc1W = tf.Variable(W_fc1)

    prev_layer = tf.nn.conv2d(prev_layer, fc1W, strides=[1, 1, 1, 1], padding='VALID')
    prev_layer = tf.nn.relu(prev_layer)
    prev_layer = tf.image.resize(prev_layer, [1, dimTxt])
    return prev_layer
